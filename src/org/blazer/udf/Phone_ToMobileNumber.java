 ...
 * 
 */
public class Phone_ToMobileNumber extends Phone_Base {
	...
	public String evaluate(String field) throws Exception {
		...
		if (len < 10) {
			...
			// 获得手机或固话
			field = super.getMobileNumber(field);
		}
		return field;
	}

	public static void main(String[] args) throws Exception {
		Phone_ToMobileNumber t = new Phone_ToMobileNumber();
		...
		for (int i = 0; i < 4000000; i++) {
			t.getMobileNumber("8620733812001");
		}
		System.out.println((System.currentTimeMillis() - l1) + "||||||");
		System.out.println(t.getMobileNumber("8621083812001"));
		System.out.println(t.getMobileNumber("8621183812001"));
		System.out.println(t.getMobileNumber("8627083812001"));
		System.out.println(t.getMobileNumber("8620733812001"));
		System.out.println(t.getMobileNumber("18105408877"));
	}
