 ...
 * 
 */
public class Phone_ToNumber extends Phone_Base {
	...
	public String evaluate(String field) throws Exception {
		...
		if (len < 10) {
			...
			// 获得手机或固话
			field = super.getNumber(field);
		}
		return field;
	}

	public static void main(String[] args) throws Exception {
		Phone_ToNumber t = new Phone_ToNumber();
		...
		for (int i = 0; i < 4000000; i++) {
			t.getNumber("8620733812001");
		}
		System.out.println((System.currentTimeMillis() - l1) + "||||||");
		System.out.println(t.getNumber("8621083812001"));
		System.out.println(t.getNumber("8621183812001"));
		System.out.println(t.getNumber("8627083812001"));
		System.out.println(t.getNumber("8620733812001"));
		System.out.println(t.getNumber("18105408877"));
	}
